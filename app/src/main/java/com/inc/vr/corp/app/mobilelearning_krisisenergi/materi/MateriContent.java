package com.inc.vr.corp.app.mobilelearning_krisisenergi.materi;
...
import com.inc.vr.corp.app.mobilelearning_krisisenergi.MateriListActivity;
...
public class MateriContent extends AppCompatActivity {
    ...
    Integer cobaa=1, tugas=1;
    Intent intent;
    String materi, judul;
    Uri URI;
    SharedPreferences myshared;
    String jenis, filenya, nama, jk, sekolah, kelas, hp, email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "my_item_name");
        ...
        try {
            ...
            for (int i=0; i<node.getLength(); i++) {
                ...
                if(anak.getNodeName().equals("html_format")){
                    //TextView tv = new TextView(this);
                    HtmlTextView tv = new HtmlTextView(this);
                    tv.setId(nomor);
                    String hh = anak.getTextContent().replace("kk2020","<");
                    tv.setHtml(hh);
                ...
                if(anak.getNodeName().equals("gambar")){
                    ...
                    ZoomageView iv = new ZoomageView(konten.getContext());
                    int resourceId = getResources().getIdentifier (anak.getTextContent(), "drawable", "com.inc.vr.corp.app.mobilelearning_krisisenergi");
                ...
                if(anak.getNodeName().equals("gambar_tengah")){
                    // add ImageView
                    Display display = getWindowManager().getDefaultDisplay();
                    ZoomageView iv = new ZoomageView(konten.getContext());
                    int resourceId = getResources().getIdentifier (anak.getTextContent(), "drawable", "com.inc.vr.corp.app.mobilelearning_krisisenergi");
                    iv.setImageResource(resourceId);
                    LinearLayout.LayoutParams attributLayoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.MATCH_PARENT);
                    attributLayoutParams.gravity = Gravity.CENTER;
                    iv.setLayoutParams(attributLayoutParams);
                ...
                if(anak.getNodeName().equals("video")){
                    ...
                    int resourceId = getResources().getIdentifier (anak.getTextContent(), "raw", "com.inc.vr.corp.app.mobilelearning_krisisenergi");
                ...
                if(anak.getNodeName().equals("tugas")){
                    ...
                    for(int u=0;u<anak2.getLength();u++){
                        ...
                        if(anaknya.getNodeName().equals("html_format")){
                            LinearLayout linearLayout5 =new LinearLayout(this);
                            linearLayout5.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                            linearLayout5.setBackgroundColor(getResources().getColor(R.color.blue_400));
                            linearLayout5.setPadding(3,3,3,3);
                            konten.addView(linearLayout5);
                            LinearLayout linearLayout6 =new LinearLayout(this);
                            linearLayout6.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                            ...
                            HtmlTextView tv = new HtmlTextView(this);
                            tv.setId(u);
                            String hhz = anaknya.getTextContent().replace("kk2020","<");
                            tv.setHtml(hhz);
                            tv.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
                                    LinearLayout.LayoutParams.WRAP_CONTENT));
                            tv.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                        ...
                        if(anaknya.getNodeName().equals("gambar")){
                            // add ImageView
                            ZoomageView iv = new ZoomageView(this);
